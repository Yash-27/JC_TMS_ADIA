...
#                         this section reached back into section 1 except
#                         through the returned `res` object, so it has now been
#                         cut into observables.jl with no edits, and is shared
#                         with the (r, ξ) sweep in run_r_xi.jl.
# ==============================================================================
...
#
# Moved to observables.jl, included above, because run_r_xi.jl needs the same
# definitions and cannot include this file to get them (including this file
# runs a whole sweep). The contents were lifted verbatim; nothing about how
# observables are added has changed.
# ==============================================================================
